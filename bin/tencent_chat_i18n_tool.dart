...
void main(List<String> arguments) async {
  ...
  stdout.write(
      "A. Add new language entries for internationalization. This action must be performed before adding new entries.\n");
  stdout.write(
      "B. Retrieve the tool's built-in language entries, including JSON files for all supported languages, and save them to your project directory for further customization.\n");
  stdout.write(
      "C. Inject your modified language JSON files for all languages back into the tool, allowing the updated configuration to take effect.\n");
...
void addNewEntries(String packagePath) async {
  ...
  if (userInput == '1') {
    ...
    File(userTxtFilePath)
        .writeAsStringSync(userEntries.toSet().toList().join('\n'));
